...
from dissector.plugins.libs.androguard.androguard.core.analysis import auto
from dissector.plugins.libs.androguard.androguard.core.androconf import set_debug
