...
# from dissector.plugins.libs.androguard.androguard.core.bytecodes.dvm_permissions import DVM_PERMISSIONS
# from dissector.plugins.libs.androguard.androguard.core.analysis.risk import PERMISSIONS_RISK, INTERNET_RISK, PRIVACY_RISK, PHONE_RISK, SMS_RISK, \
#     MONEY_RISK
# from dissector.plugins.libs.androguard.androguard.core.analysis.analysis import PathVar, TAINTED_PACKAGE_CREATE
...
from networkx import convert, NetworkXError
            ...
            if m.get_name() == "Ldalvik/system/DexClassLoader;":
                for path in m.get_paths():
                    if path.get_access_flag() == TAINTED_PACKAGE_CREATE:
                        ...
                        n2 = self._get_new_node(dst_class_name, dst_method_name,
