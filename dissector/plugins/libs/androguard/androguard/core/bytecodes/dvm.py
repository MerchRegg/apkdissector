...
from dissector.plugins.libs.androguard.androguard.core import bytecode, androconf
from dissector.plugins.libs.androguard.androguard.core.bytecodes.apk import APK
from dissector.plugins.libs.androguard.androguard.core.androconf import CONF, debug, warning
...
class ClassManager(object):
    ...
    def get_raw_string(self, idx):
        ...
        try:
            ...
            bytecode.Warning("unknown string item @ 0x%x(%d)" % (off, idx))
            #self.__manage_item["TYPE_STRING_ID_ITEM"][idx].show()
            return "AG:IS: invalid string"
