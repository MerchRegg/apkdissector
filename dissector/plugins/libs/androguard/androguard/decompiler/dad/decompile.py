...
import dissector.plugins.libs.androguard.androguard.core.androconf as androconf
...
from dissector.plugins.libs.androguard.androguard.decompiler.dad.ast import (
    ...
    dummy)
from dissector.plugins.libs.androguard.androguard.decompiler.dad.control_flow import identify_structures
from dissector.plugins.libs.androguard.androguard.decompiler.dad.dataflow import (
    build_def_use, place_declarations, dead_code_elimination,
    register_propagation, split_variables)
from dissector.plugins.libs.androguard.androguard.decompiler.dad.graph import construct, simplify, split_if_nodes
from dissector.plugins.libs.androguard.androguard.decompiler.dad.instruction import Param, ThisParam
from dissector.plugins.libs.androguard.androguard.decompiler.dad.writer import Writer
from dissector.plugins.libs.androguard.androguard.util import read
...
class DvMethod(object):
    ...
    def __init__(self, methanalysis):
        ...
        if not __debug__:
            from dissector.plugins.libs.androguard.androguard.core import bytecode
