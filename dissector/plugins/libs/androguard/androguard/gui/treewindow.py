...
from dissector.plugins.libs.androguard.androguard.gui.xrefwindow import XrefDialogClass
from dissector.plugins.libs.androguard.androguard.gui.sourcewindow import SourceWindow
from dissector.plugins.libs.androguard.androguard.gui.helpers import classdot2class, Signature
